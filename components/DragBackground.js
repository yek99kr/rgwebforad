    ...
    <>
      <div className="font-mono absolute inline top-0 left-0 w-[100vw] h-[100vh] text-sm p-4 z-[-1]">
        ...
        <p style={{ marginLeft: "4%" }}>
          ...
          <span style={{ color: "red" }}>&quot;/logo.png&quot;</span> className=
          <span style={{ color: "red" }}>&quot;logo&quot;</span>{" "}
          <span style={{ color: "#c10058" }}>/&gt;</span>
        </p>
        <p style={{ marginLeft: "4%" }}>
          . We&amp;apos;re a{" "}
          <span style={{ color: "#c10058" }}>&lt;AboutDropDown</span> madWords=
        ...
        <p style={{ marginLeft: "4%" }}>
          ...
          <span style={{ color: "#c10058" }}>/&gt;</span> to &#123;&quot;
          &quot;&#125;
        </p>
        <p style={{ marginLeft: "4%" }}>
          <span style={{ color: "#c10058" }}>&lt;AboutDropDown</span> madWords=
        ...
        <p style={{ marginLeft: "4%" }}>
          <span style={{ color: "#c10058" }}>&lt;AboutDropDown</span> madWords=
          <span style={{ color: "red" }}>&#123;madWords5&#125;</span>{" "}
          <span style={{ color: "#c10058" }}>/&gt;</span> commercials, music
          videos,
        </p>
        <p style={{ marginLeft: "4%" }}>
          XR experiences,{" "}
          <span style={{ color: "#c10058" }}>&lt;AboutDropDown</span> madWords=
          <span style={{ color: "red" }}>&#123;madWords6&#125;</span>{" "}
          <span style={{ color: "#c10058" }}>/&gt;</span> and social content.
        </p>
        <p style={{ marginLeft: "3%", color: "#c10058" }}>&lt;/p&gt;</p>
        <p style={{ marginLeft: "3%" }}>
          <span style={{ color: "#c10058" }}>&lt;p</span> className=
        ...
        <p style={{ marginLeft: "4%" }}>
          Our work <span style={{ color: "#c10058" }}>&lt;AboutDropDown</span>{" "}
          madWords=
        ...
        <p style={{ marginLeft: "4%" }}> We have an&#123;&quot; &quot;&#125;</p>
        <p style={{ marginLeft: "4%" }}>
        ...
        <p style={{ marginLeft: "4%" }}>
          ...
          &gt;deck
          <span style={{ color: "#c10058" }}>&lt;/span&gt;</span> with some
        </p>
        <p style={{ marginLeft: "4%" }}> more work.</p>
        <p style={{ marginLeft: "3%", color: "#c10058" }}> &lt;/p&gt;</p>
        <p style={{ marginLeft: "3%" }}>
          {" "}
          <span style={{ color: "#c10058" }}>&lt;p</span> className=
